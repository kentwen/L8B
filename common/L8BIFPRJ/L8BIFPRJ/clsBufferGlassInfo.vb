Public Class clsBufferGlassInfo
    ...
    Private mvarRepairReviewFlag As Integer

    '2010/10/02
    Public Property RepairReviewFlag() As Integer
        Get
            RepairReviewFlag = mvarRepairReviewFlag
        End Get
        Set(ByVal value As Integer)
            mvarRepairReviewFlag = value
        End Set
    End Property
