...
Public Class MainGUI
    ...
    Private mvarSignalOnOff(&H104F) As Integer
    Private mvarSignalName(&H104F) As String
    Private mvarModifyTime(&H104F) As String
    Private mvarCurrentGUIIdx As eEQGUIIndex
    Private mvarTabConvertString As String
    Private mvarTabConvertHex As Long
    Private mvarAlarmTable(3, 512) As Integer
    ...
    Public Property SignalOnOff(ByVal lngAddrKey As Long) As Integer
        Get
            SignalOnOff = mvarSignalOnOff(lngAddrKey)
        End Get
        Set(ByVal value As Integer)
            mvarSignalOnOff(lngAddrKey) = value
        End Set
    End Property

    Public Property SignalName(ByVal lngAddrKey As Long) As String
        Get
            SignalName = mvarSignalName(lngAddrKey)
        End Get
        Set(ByVal value As String)
            mvarSignalName(lngAddrKey) = value
        End Set
    End Property

    Public Property SignalModifyTime(ByVal lngAddrKey As Long) As String
        Get
            SignalModifyTime = mvarModifyTime(lngAddrKey)
        End Get
        Set(ByVal value As String)
            mvarModifyTime(lngAddrKey) = value
        End Set
    End Property

    Public Property AlarmOnOffEQ1(ByVal nIdx As Integer) As Integer
        Get
            AlarmOnOffEQ1 = mvarAlarmTable(1, nIdx)
        End Get
        Set(ByVal value As Integer)
            mvarAlarmTable(1, nIdx) = value
        End Set
    End Property

    Public Property AlarmOnOffEQ2(ByVal nIdx As Integer) As Integer
        Get
            AlarmOnOffEQ2 = mvarAlarmTable(2, nIdx)
        End Get
        Set(ByVal value As Integer)
            mvarAlarmTable(2, nIdx) = value
        End Set
    End Property

    Public Property AlarmOnOffEQ3(ByVal nIdx As Integer) As Integer
        Get
            AlarmOnOffEQ3 = mvarAlarmTable(3, nIdx)
        End Get
        Set(ByVal value As Integer)
            mvarAlarmTable(3, nIdx) = value
        End Set
    End Property
...
#Region "Private Sub"
    ...
    Private Sub IniLinkMapGUI()
        ...
        For i As Integer = 0 To UBound(mvarSignalName)
    ...
    Private Function ConvertAddrToHex(ByVal lngKeyIndex As Long) As String
        ...
        If mvarSignalName(lngKeyIndex) <> "" Then
        ...
        Select Case mvarCurrentGUIIdx
            ...
            Case eEQGUIIndex.IDX_2ND_20LINK
                ...
                ElseIf Me.OcxLinkState1.TabIdx = 1 Then
                    OcxLinkState1.SetSignalOnOff("80", SignalOnOff(&H0))
                    OcxLinkState1.SetSignalOnOff("81", SignalOnOff(&H1))
                    OcxLinkState1.SetSignalOnOff("700", SignalOnOff(&H300))
                    OcxLinkState1.SetSignalOnOff("701", SignalOnOff(&H301))
                ElseIf Me.OcxLinkState1.TabIdx = 2 Then
                    OcxLinkState1.SetSignalOnOff("100", SignalOnOff(&H0))
                    OcxLinkState1.SetSignalOnOff("101", SignalOnOff(&H1))
                    OcxLinkState1.SetSignalOnOff("1000", SignalOnOff(&H300))
                    OcxLinkState1.SetSignalOnOff("1001", SignalOnOff(&H301))
                End If
            ...
            Case eEQGUIIndex.IDX_2ND_22GXLOAD
                ...
                ElseIf Me.OcxGxLoad1.TabIdx = 2 Then
                    ...
                    OcxGxLoad1.SetSignalOnOff("122", SignalOnOff(&H112))
            ...
            Case eEQGUIIndex.IDX_2ND_26GX_ERASE
                If Me.OcxGxErase1.TabIdx = 0 Then
                    OcxGxErase1.SetSignalOnOff("43", SignalOnOff(&H40))
                    OcxGxErase1.SetSignalOnOff("343", SignalOnOff(&H340))
                ElseIf Me.OcxGxErase1.TabIdx = 1 Then
                    OcxGxErase1.SetSignalOnOff("C3", SignalOnOff(&HC0))
                    OcxGxErase1.SetSignalOnOff("743", SignalOnOff(&H740))
                ElseIf Me.OcxGxErase1.TabIdx = 2 Then
                    OcxGxErase1.SetSignalOnOff("143", SignalOnOff(&H140))
                    OcxGxErase1.SetSignalOnOff("1043", SignalOnOff(&H1040))
                End If
            Case eEQGUIIndex.IDX_2ND_27RECIPE_CHK
                If Me.OcxPPIDChk1.TabIdx = 0 Then
                    OcxPPIDChk1.SetSignalOnOff("45", SignalOnOff(&H40))
                    OcxPPIDChk1.SetSignalOnOff("345", SignalOnOff(&H340))
                ElseIf Me.OcxPPIDChk1.TabIdx = 1 Then
                    OcxPPIDChk1.SetSignalOnOff("C5", SignalOnOff(&HC0))
                    OcxPPIDChk1.SetSignalOnOff("745", SignalOnOff(&H740))
                ElseIf Me.OcxPPIDChk1.TabIdx = 2 Then
                    OcxPPIDChk1.SetSignalOnOff("145", SignalOnOff(&H140))
                    OcxPPIDChk1.SetSignalOnOff("1045", SignalOnOff(&H1040))
                End If
            ...
            Case eEQGUIIndex.IDX_3RD_30LINK
                ...
                ElseIf Me.OcxTimeCht_Link1.TabIdx = 1 Then
                    OcxTimeCht_Link1.SetSignalOnOff("80", SignalOnOff(&H0))
                    OcxTimeCht_Link1.SetSignalOnOff("81", SignalOnOff(&H1))
                    OcxTimeCht_Link1.SetSignalOnOff("700", SignalOnOff(&H300))
                    OcxTimeCht_Link1.SetSignalOnOff("701", SignalOnOff(&H301))
                ElseIf Me.OcxTimeCht_Link1.TabIdx = 2 Then
                    OcxTimeCht_Link1.SetSignalOnOff("100", SignalOnOff(&H0))
                    OcxTimeCht_Link1.SetSignalOnOff("101", SignalOnOff(&H1))
                    OcxTimeCht_Link1.SetSignalOnOff("1000", SignalOnOff(&H300))
                    OcxTimeCht_Link1.SetSignalOnOff("1001", SignalOnOff(&H301))
                End If
            ...
            Case eEQGUIIndex.IDX_3RD_31GXLOAD
                ...
                ElseIf Me.OcxGxLoad1.TabIdx = 2 Then
                    ...
                    OcxTimeCht_GxLoad1.SetSignalOnOff("122", SignalOnOff(&H112))
            ...
            Case eEQGUIIndex.IDX_3RD_35GX_ERASE
                If Me.OcxTimeCht_GxErase1.TabIdx = 0 Then
                    OcxTimeCht_GxErase1.SetSignalOnOff("43", SignalOnOff(&H40))
                    OcxTimeCht_GxErase1.SetSignalOnOff("343", SignalOnOff(&H340))
                ElseIf Me.OcxTimeCht_GxErase1.TabIdx = 1 Then
                    OcxTimeCht_GxErase1.SetSignalOnOff("C3", SignalOnOff(&HC0))
                    OcxTimeCht_GxErase1.SetSignalOnOff("743", SignalOnOff(&H740))
                ElseIf Me.OcxTimeCht_GxErase1.TabIdx = 2 Then
                    OcxTimeCht_GxErase1.SetSignalOnOff("143", SignalOnOff(&H140))
                    OcxTimeCht_GxErase1.SetSignalOnOff("1043", SignalOnOff(&H1040))
                End If

            Case eEQGUIIndex.IDX_3RD_36RECIPE_CHK
                If Me.OcxTimeCht_PPIDChk1.TabIdx = 0 Then
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("45", SignalOnOff(&H40))
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("345", SignalOnOff(&H340))
                ElseIf Me.OcxTimeCht_PPIDChk1.TabIdx = 1 Then
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("C5", SignalOnOff(&HC0))
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("745", SignalOnOff(&H740))
                ElseIf Me.OcxTimeCht_PPIDChk1.TabIdx = 2 Then
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("145", SignalOnOff(&H140))
                    OcxTimeCht_PPIDChk1.SetSignalOnOff("1045", SignalOnOff(&H1040))
                End If
        End Select
    End Sub
