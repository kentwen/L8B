...
Public Class OcxTimeCht_PPIDChk
    ...
    Public Sub SetSignalOnOff(ByVal strSignalID As String, ByVal nOnOff As Integer)
        Select Case strSignalID
            Case "45", "C5", "145"
                If nOnOff = 1 Then
                    Me.shpPPIDChkReq.BackColor = BackColorForRSTSignalON
                Else
                    Me.shpPPIDChkReq.BackColor = BackColorForSignalOFF
                End If
            Case "345", "745", "1045"
                If nOnOff = 1 Then
                    Me.shPPIDChkAck.BackColor = BackColorForCVSignalON
                Else
                    Me.shPPIDChkAck.BackColor = BackColorForSignalOFF
                End If
