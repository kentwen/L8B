...
Public Class CVGUIMain
    ...
    Public Property AlarmOnOff(ByVal nIdx As Integer) As Integer
        Get
            AlarmOnOff = mvarAlarmTable(nIdx)
        End Get
        Set(ByVal value As Integer)
            mvarAlarmTable(nIdx) = value
        End Set
    End Property
...
#Region "Private Sub / Function"
    ...
    Private Sub IniLinkMapGUI()
        ...
        For i As Integer = 1 To UBound(mvarSignalName)
    ...
    Private Sub GUISignalCTL()
        ...
        Select Case mvarCurrentGUIIdx
            ...
            Case eCVGUIIndex.IDX_2ND_12STATUS_MAIN
                ...
                Me.StatusReport1.SetSignalOnOff("1325", SignalOnOff(&H184))
                '========================================================================================================
            ...
            Case eCVGUIIndex.IDX_2ND_15GX_DATA_REQ
                ...
                Me.GxDataReq1.SetSignalOnOff("13B0", SignalOnOff(&H184))
                '========================================================================================================
            ...
            Case eCVGUIIndex.IDX_3ND_13GX_DATA_REQ
                ...
                Me.TimeChart_GxDataReq1.SetSignalOnOff("13B0", SignalOnOff(&H184))
                '========================================================================================================
            ...
            Case eCVGUIIndex.IDX_3ND_23CST_UNLOAD_BY_RST
                TabConvert("01A0", Me.TimeChart_CSTUnloadReqByRST1.TabIndex)
                Me.TimeChart_CSTUnloadReqByRST1.SetSignalOnOff(TabConvertValString, SignalOnOff(TabConvertValHex))
                TabConvert("01AB", Me.TimeChart_CSTUnloadReqByRST1.TabIndex)
                Me.TimeChart_CSTUnloadReqByRST1.SetSignalOnOff(TabConvertValString, SignalOnOff(TabConvertValHex))
                TabConvert("01B0", Me.TimeChart_CSTUnloadReqByRST1.TabIndex)
                Me.TimeChart_CSTUnloadReqByRST1.SetSignalOnOff(TabConvertValString, SignalOnOff(TabConvertValHex))
                TabConvert("1370", Me.TimeChart_CSTUnloadReqByRST1.TabIndex)
                Me.TimeChart_CSTUnloadReqByRST1.SetSignalOnOff(TabConvertValString, SignalOnOff(TabConvertValHex))
                '========================================================================================================
