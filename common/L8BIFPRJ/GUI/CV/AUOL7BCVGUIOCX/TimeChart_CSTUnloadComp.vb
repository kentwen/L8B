Public Class TimeChart_CSTUnloadComp
    ...
    Public Sub SetSignalOnOff(ByVal strSignalID As String, ByVal nOnOff As Integer)
        Select Case strSignalID
            Case "01B8", "01B9", "01BA", "01BB", "01BC"
                If nOnOff = 1 Then
                    Me.B01B8.BackColor = BackColorForRSTSignalON
                Else
                    Me.B01B8.BackColor = BackColorForSignalOFF
                End If
            Case "1378", "1379", "137A", "137B", "137C"
                If nOnOff = 1 Then
                    Me.B1378.BackColor = BackColorForCVSignalON
                Else
                    Me.B1378.BackColor = BackColorForSignalOFF
                End If
        End Select
    End Sub
