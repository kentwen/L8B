Public Class TimeChart_GxAbnormal
    ...
    Public Sub SetSignalOnOff(ByVal strSignalID As String, ByVal nOnOff As Integer)
        Select Case strSignalID
            Case "01D7"
                If nOnOff = 1 Then
                    Me.B01D7.BackColor = BackColorForRSTSignalON
                Else
                    Me.B01D7.BackColor = BackColorForSignalOFF
                End If
            Case "13B6"
                If nOnOff = 1 Then
                    Me.B13B6.BackColor = BackColorForCVSignalON
                Else
                    Me.B13B6.BackColor = BackColorForSignalOFF
                End If
            Case "13F0"
                'If nOnOff = 1 Then
                '    Me.lblSignalGxAbnormalReportAck.BackColor = BackColorForRSTSignalON
                'Else
