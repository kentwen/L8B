...
Public Class CSTUnloadByCV
    ...
    Public Sub SetSignalOnOff(ByVal strSignalID As String, ByVal nOnOff As Integer)
        Select Case strSignalID
            Case "01A0", "01A1", "01A2", "01A3", "01A4"
                If nOnOff = 1 Then
                    Me.cmdCSTUnloadAck.BackColor = BackColorForRSTSignalON
                Else
                    Me.cmdCSTUnloadAck.BackColor = BackColorForSignalOFF
                End If
    ...
    Private Sub cmdCSTUnloadAck_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCSTUnloadAck.Click
        Dim nConvertPortIndex As Integer
        nConvertPortIndex = TabControl1.SelectedIndex
        If Not ENGType Then Exit Sub
    ...
    Public Sub ShowGUIUnloadRequestByCV()
        Dim nConvertPortIndex As Integer
