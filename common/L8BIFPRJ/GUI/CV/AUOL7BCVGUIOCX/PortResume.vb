...
Public Class PortResume
    ...
    Public Sub SetSignalOnOff(ByVal strSignalID As String, ByVal nOnOff As Integer)
        Select Case strSignalID
            Case "0228", "0229", "022A", "022B", "022C"
                If nOnOff = 1 Then
                    Me.cmdResumeReq.BackColor = BackColorForRSTSignalON
                Else
                    Me.cmdResumeReq.BackColor = BackColorForSignalOFF
                End If
            Case "1368", "1369", "136A", "136B", "136C"
                If nOnOff = 1 Then
                    Me.lblSignalResumeAck.BackColor = BackColorForCVSignalON
                Else
                    Me.lblSignalResumeAck.BackColor = BackColorForSignalOFF
                End If
        End Select
    End Sub
    ...
    Private Sub cmdResumeReq_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdResumeReq.Click
        Dim nConvertPortIndex As Integer
        ...
        Select Case nConvertPortIndex
            Case "0"
                RaiseEvent RSTSignalClick("0228")
            Case "1"
                RaiseEvent RSTSignalClick("0229")
            Case "2"
                RaiseEvent RSTSignalClick("022A")
            Case "3"
                RaiseEvent RSTSignalClick("022B")
            Case "4"
                RaiseEvent RSTSignalClick("022C")
        End Select
    End Sub
End Class
